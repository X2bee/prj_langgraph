...
graph_builder.add_node("Query Select", query_select_node)
graph_builder.add_node("X2BEE Enter", x2bee_login_node)
graph_builder.add_node("Item Select", item_select_node)
graph_builder.add_node("Item Buy", item_buy_node)
...
graph_builder.add_edge("Query Select", "X2BEE Enter")
graph_builder.add_edge("X2BEE Enter", "Item Select")
graph_builder.add_edge("Item Select", "Item Buy")
graph_builder.add_edge("Item Buy", END)
graph_builder.add_conditional_edges(
    "Query Check", 
    select_next_node, 
    {"is_revise": "Query Revise Tool", END: "Query Select"}
)
graph_builder.add_conditional_edges(
    "Character Make",
    simple_route,
